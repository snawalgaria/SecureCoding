...
class Database {
    ...
    public static function open() {
        try {
            ...
            Database::ensureExists("users", "`userid` INT(11) AUTO_INCREMENT PRIMARY KEY, `email` VARCHAR(64) NOT NULL, `isEmployee` BIT(1) NOT NULL, `isVerified` BIT(1) NOT NULL, `credentials` TINYTEXT NOT NULL");
            ...
            // Generated TANs
            Database::ensureExists("tans", "tan CHAR(15) PRIMARY KEY");
            return TRUE;
        } catch (Exception $e) {
            $_ENV["DBError"] = $e;
            return FALSE;
