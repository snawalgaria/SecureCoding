...
\textbf{Observation} & We were not able to find any reflected XSS vulnerability in this application. \\
...
\subsubsection*{Comparison}
Based on our testing, we found that both applications operate on a similar security level.
